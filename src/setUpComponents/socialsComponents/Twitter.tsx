...
export function Twitter() {
    ...
    return (
        <div>
            <h2>Twitter</h2>
            <h3>Have a Twitter list or an account you'd like to keep up with? Please fill below:</h3>
            ...
            {/* <h3>To learn more about Twitter lists, click <a href="https://help.twitter.com/en/using-twitter/twitter-lists" target="_blank">here</a></h3> */}

            {type === 'account' ? 
                <>
                    <FormControl style={{width: '20%'}} sx={{mb: 2}} size='small'>
                        <InputLabel htmlFor="account">Account Name</InputLabel>
                        <Input id="account" value={account} onChange = {(e: any) => setAccount(e.target.value)}/>
                    </FormControl>
                    <br/><br/><br/><br/><br/><br/>
                </>
                :
                <>
                    <FormControl style={{width: '20%'}} sx={{mb: 2}} size='small'>
                        ...
                        <Input id="list" value={list} onChange = {(e: any) => setList(e.target.value)}/>
                    </FormControl>
                    <br/>
                    <FormControl style={{width: '20%'}} sx={{mb: 2}} size='small'>
                        <InputLabel htmlFor="author">List Author</InputLabel>
                        <Input id="author" value={author} onChange = {(e: any) => setAuthor(e.target.value)}/>
                    </FormControl>
